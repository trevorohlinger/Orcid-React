   ...
   if (values.code /* this.state.success == true*/)
    ...
    //    window.location.href=`${API_URL}success`
      ...
      } else if (values.access_token && this.state.success == false)
        {
          ...
          window.location.href=`https://sandbox.orcid.org/oauth/authorize?client_id=APP-RASOJQY62Z86Q8CU&response_type=code&scope=/read-limited%20/activities/update%20/person/update&redirect_uri=https://spm35eaceb.execute-api.us-west-2.amazonaws.com/dev/access`
      } else {
