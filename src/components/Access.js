...
class Access extends Component {
  ...
  parseJwt(token) {
    ...
    componentDidMount() {
      ...
      const ENV_CLIENT_ID = process.env.ENV_CLIENT_ID;
  ...
  // window.location.href='https://sandbox.orcid.org/oauth/authorize?client_id=APP-RASOJQY62Z86Q8CU&response_type=code&scope=/read-limited%20/activities/update%20/person/update&redirect_uri=https://localhost:3000/access'
     window.location.href=`https://sandbox.orcid.org/oauth/authorize?client_id=${ENV_CLIENT_ID}&response_type=code&scope=/read-limited%20/activities/update%20/person/update&redirect_uri=${API_URL}access`
